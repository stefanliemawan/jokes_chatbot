...
data["category"].replace("Computers", "Computer", inplace=True)
data["category"].replace("Crazy Jokes", "Crazy", inplace=True)
data["category"].replace("Deep Thoughts", "Deep Thoughts", inplace=True)
data["category"].replace("Ethnic Jokes", "Ethnic", inplace=True)
data["category"].replace("Farmers", "Farmer", inplace=True)
data["category"].replace('"Family, Parents"', "Family, Parents", inplace=True)
